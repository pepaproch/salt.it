...
This is the very first version, feel free to use for any frontend.app. Contributions are always welcome!
...
3. `npm install`
4. `npm start` will run the frontend.app
5. Visit the frontend.app at [http://localhost:3000](http://localhost:3000)
